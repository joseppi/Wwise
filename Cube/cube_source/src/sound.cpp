...
#ifdef AK_WIN // use DLL on Windows
...
void snd_init()
{
	...
	SOUNDENGINE_DLL::SetBasePath( L"soundbanks\\Windows\\" );
	...
	// Enable motion for local player
#ifdef AK_MOTION
	MotionEngine::AddPlayerMotionDevice( 0, AKCOMPANYID_AUDIOKINETIC, AKMOTIONDEVICEID_RUMBLE, NULL );
